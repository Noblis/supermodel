...
namespace Supermodel.ApiClient.Models
{
    ...
    public partial class ToDoList
    {
        ...
        #region Properties
        [JsonIgnore, NotRMapped] public ImageSource IconImageSource => ImageSource.FromResource("TDM.Mobile.EmbeddedResources.List.png");
        [JsonIgnore, NotRMapped] public string ItemsCount => $"Completed: {ToDoItems.Count(x => x.Completed)} Pending:{ToDoItems.Count(x => !x.Completed)}";
        #endregion
    }
}
