...
{
    public class MyToDoListDetailPage : CRUDDetailPage<ToDoList, ToDoListXFModel, TDMSqliteDataContext>
    {
        #region Initializers
        public override async Task<CRUDDetailPage<ToDoList, ToDoListXFModel, TDMSqliteDataContext>> InitAsync(ObservableCollection<ToDoList> models, string title, ToDoList model)
        {
